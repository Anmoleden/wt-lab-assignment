...
<form method="POST" action="../save/" enctype="multipart/form-data">
	<div class="form-group">
		...
		<input type="text" id="name" placeholder="Anmol Regmi" name="name">
	</div>
	<div class="form-group">
		<label for="email">Email</label>
		<input type="email" id="email" placeholder="anamolregmi1@gmail.com" name="email">
	</div>
	<div class="form-group">
		<label for="password">Password</label>
		<input type="password" id="password" placeholder="anmolregmi" name="password">
	</div>
	<div class="form-group">
